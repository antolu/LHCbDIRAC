########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/scripts/Attic/dirac_functions.py,v 1.32 2008/04/15 21:31:03 rgracian Exp $
# File :   dirac-functions.py
# Author : Ricardo Graciani
########################################################################
__RCSID__   = "$Id: dirac_functions.py,v 1.32 2008/04/15 21:31:03 rgracian Exp $"
      ...
      if input.isfirstline():
        if re.compile( '^#!.*python').match(line):
          ...
          if len( magic ) < 100:
            ...
            print '  sys.exit( os.system( "\%s \%s" \% ( sys.executable, str.join(' ',sys.argv ) )  )'
        else:
          print line,
      else:
        print line,
