#!/bin/bash
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/scripts/install_volhcb06.sh,v 1.4 2009/10/07 13:42:53 rgracian Exp $
...
DIRACHOST=volhcb06.cern.ch
#
# Location of the installation
DESTDIR=/opt/dirac
#
SiteName=VOLHCB06.CERN.CH
