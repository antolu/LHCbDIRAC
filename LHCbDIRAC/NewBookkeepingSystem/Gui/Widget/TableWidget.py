...
from LHCbDIRAC.NewBookkeepingSystem.Gui.Widget.TableWidget_ui     import Ui_TableWidget
from LHCbDIRAC.NewBookkeepingSystem.Gui.Controler.ControlerTable  import ControlerTable
