...
#    result = {'OK':True,'Value':(0,'Disabled Execution','')}
    ...
    streamingJobTypes = ['datastripping','datareconstruction','hospital']
  ...
  def manageDaVinciStreamingStep(self):
    """ Function to manage the outputs of a DaVinci streaming step. Relies on the
        workflow commons dictionary and the outputlist and updates these in case
