########################################################################
# $Id: StepFinalization.py 18064 2009-11-05 19:40:01Z acasajus $
########################################################################


__RCSID__ = "$Id: StepFinalization.py 18064 2009-11-05 19:40:01Z acasajus $"
...
# should put a try/except
    self.log.info(os.system('env|sort'))
