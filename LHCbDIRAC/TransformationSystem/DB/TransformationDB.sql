...
ALTER TABLE TransformationFiles ADD COLUMN (RunNumber INT(11) DEFAULT 0, FileSize BIGINT DEFAULT NULL, FileType VARCHAR(32) DEFAULT NULL, NumberOfRAWAncestors INT(11) DEFAULT NULL) ;
