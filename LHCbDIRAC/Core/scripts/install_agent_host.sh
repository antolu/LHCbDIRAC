...
$DESTDIR/pro/scripts/install_agent.sh Configuration          CE2CSAgent
...
$DESTDIR/pro/scripts/install_agent.sh ResourceStatus         SSInspectorAgent
$DESTDIR/pro/scripts/install_agent.sh ResourceStatus         SeSInspectorAgent
$DESTDIR/pro/scripts/install_agent.sh ResourceStatus         StElInspectorAgent

$DESTDIR/pro/scripts/install_agent.sh SAM                    SAMAgent
