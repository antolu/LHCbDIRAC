...
DIRACUSER=dirac
#
# Host where it is allow to run the script
DIRACHOST=volhcb15.cern.ch
#
# Location of the installation
DESTDIR=/opt/dirac
#
SiteName=VOLHCB15.CERN.CH
DIRACSETUP=LHCb-NewProduction
DIRACVERSION=v5r0p0-pre22
DIRACARCH=Linux_x86_64_glibc-2.5
DIRACPYTHON=25
DIRACDIRS="startup runit data work control requestDB storage"
DIRACDBs=""
