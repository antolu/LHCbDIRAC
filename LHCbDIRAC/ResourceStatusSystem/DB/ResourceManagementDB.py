...
class JobAccountingCache(rmsBase):
  ...
  failed = Column( 'Failed', DOUBLE, nullable = False, server_default = '0' )
  running = Column( 'Running', DOUBLE, nullable = False, server_default = '0' )
  done = Column( 'Done', DOUBLE, nullable = False, server_default = '0' )
  stalled = Column( 'Stalled', DOUBLE, nullable = False, server_default = '0' )
  checking = Column( 'Checking', DOUBLE, nullable = False, server_default = '0' )
  completed = Column( 'Completed', DOUBLE, nullable = False, server_default = '0' )
  killed = Column( 'Killed', DOUBLE, nullable = False )
  matched = Column( 'Matched', DOUBLE, nullable = False, server_default = '0' )
  lastchecktime = Column( 'LastCheckTime', DateTime, nullable = False )
...
class PilotAccountingCache(rmsBase):
  ...
  name = Column( 'Name', String( 64 ), nullable = False, primary_key = True )
  failed = Column( 'Failed', DOUBLE, nullable = False, server_default = '0' )
  deleted = Column( 'Deleted', DOUBLE, nullable = False, server_default = '0' )
  done = Column( 'Done', DOUBLE, nullable = False, server_default = '0' )
  aborted = Column( 'Aborted', DOUBLE, nullable = False, server_default = '0' )
  lastchecktime = Column( 'LastCheckTime', DateTime, nullable = False )
