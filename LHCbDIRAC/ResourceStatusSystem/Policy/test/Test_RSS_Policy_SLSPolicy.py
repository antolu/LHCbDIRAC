...
class SLSPolicy_TestCase( unittest.TestCase ):
  ...
  def setUp( self ):
    ...
    import LHCbDIRAC.ResourceStatusSystem.Policy.SLS_Policy as moduleTested
    moduleTested.PolicyBase = PolicyBase   
    moduleTested.SLS_Policy.__bases__ = ( PolicyBase, ) 

    self.policy = moduleTested.SLS_Policy
...
class SLSPolicy_Success( SLSPolicy_TestCase ):
  ...
  def test_instantiate( self ):
    ...
    '''  
    p = self.policy()
    self.assertEqual( 'SLS_Policy', p.__class__.__name__ )
