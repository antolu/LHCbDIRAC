...
class FakePolicy_TestCase( unittest.TestCase ):
  ...
  def setUp( self ):
    ...
    import LHCbDIRAC.ResourceStatusSystem.Policy.FakePolicy as moduleTested
    moduleTested.PolicyBase = PolicyBase   
    moduleTested.FakePolicy.__bases__ = ( PolicyBase, ) 

    self.policy = moduleTested.FakePolicy
...
class FakePolicy_Success( FakePolicy_TestCase ):
  ...
  def test_instantiate( self ):
    ...
    '''  
    p = self.policy()
    self.assertEqual( 'FakePolicy', p.__class__.__name__ )
