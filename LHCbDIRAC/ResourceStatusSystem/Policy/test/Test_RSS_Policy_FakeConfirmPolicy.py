...
class FakeConfirmPolicy_TestCase( unittest.TestCase ):
  ...
  def setUp( self ):
    ...
    import LHCbDIRAC.ResourceStatusSystem.Policy.FakeConfirmPolicy as moduleTested
    moduleTested.PolicyBase = PolicyBase   
    moduleTested.FakeConfirmPolicy.__bases__ = ( PolicyBase, ) 

    self.policy = moduleTested.FakeConfirmPolicy
...
class FakeConfirmPolicy_Success( FakeConfirmPolicy_TestCase ):
  ...
  def test_instantiate( self ):
    ...
    '''  
    p = self.policy()
    self.assertEqual( 'FakeConfirmPolicy', p.__class__.__name__ )
