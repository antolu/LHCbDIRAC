########################################################################
# $Id: NewBookkeepingReport.py,v 1.1 2008/06/17 09:55:29 joel Exp $
########################################################################
""" Bookkeeping Report Class """

__RCSID__ = "$Id: NewBookkeepingReport.py,v 1.1 2008/06/17 09:55:29 joel Exp $"
...
class BookkeepingReport(ModuleBase):
  ...
  def makeBookkeepingXMLString(self):
    ...
    s = s+self.__parameter_string("JobId",self.JOB_ID,'Info')
