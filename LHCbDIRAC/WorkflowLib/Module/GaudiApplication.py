########################################################################
# $Id: GaudiApplication.py,v 1.153 2009/10/19 07:54:51 paterson Exp $
########################################################################
""" Gaudi Application Class """

__RCSID__ = "$Id: GaudiApplication.py,v 1.153 2009/10/19 07:54:51 paterson Exp $"
...
class GaudiApplication(ModuleBase):
  ...
  def managePy(self):
    ...
    try:
        ...
        self.log.info('Extra options generated by GaudiApplication for this step:')
...
#        comm = 'gaudirun.py  '+self.optfile+' $LB'+self.generator_name.upper()+'ROOT/options/'+self.generator_name+'.opts ./'+self.optfile_extra+'\n'
    ...
    if self.jobType.lower()=='datastripping' and self.applicationName.lower()=='davinci' and self.applicationType.lower()=='dst':
