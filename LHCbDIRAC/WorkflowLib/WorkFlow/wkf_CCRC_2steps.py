...
step2.appendParameterCopyLinked(module5.parameters)
...
stepInstance2.unlinkParameter(["outputData"])

#stepInstance2.setValue("outputDataSE","CERN-DST")
...
workflow1.appendParameterCopyLinked(step2.parameters, step2_prefix)
...
#workflow1.removeParameter(step2_prefix+"outputDataSE")
