...
##########  PART TO EDIT  ##############
wkf_name = "CCRC_Reconstruction_Phase2"
nb_evt_step1 = 25000 #changed from -1 after meeting of 5th May
...
indata = "LFN:/lhcb/data/CCRC08/RAW/LHCb/CCRC/420161/420161_0000103619.raw"
...
step1.addParameterLinked(module4.parameters)
step1.addParameterLinked(module5.parameters)
...
workflow1.addParameter(Parameter("JobType","reconstruction","JDL","","",True, False, "Job Type"))
workflow1.addParameter(Parameter("Owner","paterson","JDL","","",True, False, "user Name"))
...
workflow1.addParameter(Parameter("SoftwarePackages","Brunel.v32r5","JDL","","",True, False, "software"))
...
if os.path.exists('wkf_CCRC_Phase2_Reconstruction.xml'):
  print 'Removed existing workflow'
  os.remove('wkf_CCRC_Phase2_Reconstruction.xml')
workflow1.toXMLFile('wkf_CCRC_Phase2_Reconstruction.xml')
