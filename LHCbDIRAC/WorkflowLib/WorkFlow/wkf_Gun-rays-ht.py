...
wkf_name = "Particule_Gun_HT_"+eventTypeSignal
...
Gauss_optfile = "Gauss-2008.py;$DECFILESROOT/options/@{eventType}.opts;$GAUSSOPTS/RichExtendedInfo.opts;$GAUSSOPTS/DRaysOn-HT.opts"
...
workflow1.addParameter(Parameter("configVersion","2008-HT","string","","",True, False, "Configuration Version"))
