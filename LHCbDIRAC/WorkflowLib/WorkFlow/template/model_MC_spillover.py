...
# this workflow run 5 steps (Gauss-Signal - Gauss-MB - Gauss-MB - Boole (with SpillOver)- Brunel)
wkf_name = ""
...
list1_out=[{"outputDataName":"@{STEP_ID}.@{applicationType}","outputDataType":"@{applicationType}","outputDataSE":Gauss_SE}]
...
list11_out=[{"outputDataName":"@{STEP_ID}.@{applicationType}","outputDataType":"@{applicationType}","outputDataSE":Gauss_SE}]
...
list12_out=[{"outputDataName":"@{STEP_ID}.@{applicationType}","outputDataType":"@{applicationType}","outputDataSE":Gauss_SE}]
...
list2_out=[{"outputDataName":"@{STEP_ID}.@{applicationType}","outputDataType":"@{applicationType}","outputDataSE":Boole_SE}]
...
list3_out=[{"outputDataName":"@{STEP_ID}.@{applicationType}","outputDataType":"@{applicationType}","outputDataSE":Brunel_SE}]
...
#workflow1.addParameter(Parameter("Site","LCG.CERN.ch;LCG.CNAF.it;LCG.RAL.uk;LCG.PIC.es;LCG.IN2P3.fr;LCG.NIKHEF.nl;LCG.GRIDKA.de","JDLReqt","","",True, False, "user Name"))
