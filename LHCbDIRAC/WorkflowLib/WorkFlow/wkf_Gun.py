...
numberEventSignal = 40000
Gauss_version = "v35r0" #v35r0
Gauss_optfile = "Gauss-2008.py"
...
workflow1.addParameter(Parameter("InputSandbox","LFN:/lhcb/applications/WorkflowLib-wkf-v3r0.tar.gz","JDL","","",True, False, "Job Type"))
