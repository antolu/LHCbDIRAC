...
wkf_name = "Particule_Gun_LT_"+eventTypeSignal
...
Gauss_optfile = "Gauss-2008.py;$DECFILESROOT/options/@{eventType}.opts;$GAUSSOPTS/RichExtendedInfo.opts;$GAUSSOPTS/DRaysOn-LT.opts"
...
workflow1.addParameter(Parameter("configVersion","2008-LT","string","","",True, False, "Configuration Version"))
