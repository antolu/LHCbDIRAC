...
wkf_name = "Particule_Gun_QGSP_"+eventTypeSignal
#eventTypeSignal = "30000000"
...
Gauss_optfile = "Gauss-2008.py;$DECFILESROOT/options/@{eventType}.opts;$GAUSSOPTS/RichExtendedInfo.opts;$GAUSSOPTS/PhysList-QGSP.opts"
...
workflow1.addParameter(Parameter("configVersion","2008-QGSP","string","","",True, False, "Configuration Version"))
