########################################################################
# $Id: ProgressThread.py,v 1.2 2008/10/09 13:50:43 zmathe Exp $
########################################################################
...
__RCSID__ = "$Id: ProgressThread.py,v 1.2 2008/10/09 13:50:43 zmathe Exp $"
...
class ProgressThread(QThread):
  ...
  def run(self):
    i = 0
    progressDialog = QProgressDialog(QString(), QString(),0,1000)
    ...
    while ( not self.__stoped):
      ...
      if i == progressDialog.maximum():
        sleepingTime = 1
        i = 0
      progressDialog.setLabelText(self.tr('marha'))
