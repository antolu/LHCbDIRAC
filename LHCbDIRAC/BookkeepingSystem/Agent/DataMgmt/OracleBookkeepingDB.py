########################################################################
# $Id: OracleBookkeepingDB.py,v 1.23 2008/06/04 12:44:15 zmathe Exp $
########################################################################
"""

"""

__RCSID__ = "$Id: OracleBookkeepingDB.py,v 1.23 2008/06/04 12:44:15 zmathe Exp $"
...
class OracleBookkeepingDB(IBookkeepingDB):
  ...
  #############################################################################
  def getProductionsWithConfigNameConfigVersion(self, configName, configVersion):
