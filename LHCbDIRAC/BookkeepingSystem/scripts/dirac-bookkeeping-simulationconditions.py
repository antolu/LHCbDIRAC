#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/DIRAC/BookkeepingSystem/scripts/Attic/dirac-bookkeeping-simulationconditions.py,v 1.4 2008/10/15 11:51:10 joel Exp $
# File :   dirac-bookkeeping-simulationconditions
# Author : Zoltan Mathe
########################################################################
__RCSID__   = "$Id: dirac-bookkeeping-simulationconditions.py,v 1.4 2008/10/15 11:51:10 joel Exp $"
__VERSION__ = "$ $"
