...
class BookkeepingManagerHandler( RequestHandler ):
  ...
  def export_getConditions(self, dict):
    ...
    if 'EventTypeId' in dict:
      gLogger.error('EventTypeId will be not accepted! Please change it to EventType')
  ...
  def export_getProductions(self, dict):
    ...
    if 'EventTypeId' in dict:
      gLogger.error('The EventTypeId has to be replaced by EventType!')
  ...
  def transfer_toClient(self, parameters, token, fileHelper):
    ...
    if 'Quality' in dict:
      gLogger.error('The Quality has to be replaced by DataQuality!')
  ...
  def export_getFiles(self, values):
    ...
    if 'ProductionID' in values:
      gLogger.error('ProductionID will be removed. It will changed to Production')

    if 'DataQualityFlag' in values:
      gLogger.error('DataQualityFlag will be removed. It will changed to DataQuality')

    if 'RunNumbers' in values:
      gLogger.error('RunNumbers will be removed. It will changed to RunNumbers')
