#!/bin/bash
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/LHCbSystem/Environments/SAMEnv.sh,v 1.2 2008/08/04 18:12:03 rgracian Exp $
# File :   SAMEnv.sh
# Author : Ricardo Graciani
########################################################################
__RCSID__="$Id: SAMEnv.sh,v 1.2 2008/08/04 18:12:03 rgracian Exp $"
...
export PS1="(\[\e[1;38m\]DIRAC3-SGM\[\e[0m\])[\u@\h \w]\$ "
bash -p
