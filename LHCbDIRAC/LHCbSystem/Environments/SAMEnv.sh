#!/bin/bash
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/LHCbSystem/Environments/SAMEnv.sh,v 1.1 2008/07/31 10:30:47 rgracian Exp $
# File :   SAMEnv.sh
# Author : Ricardo Graciani
########################################################################
__RCSID__="$Id: SAMEnv.sh,v 1.1 2008/07/31 10:30:47 rgracian Exp $"
...
echo
echo Running DIRAC SAMEnv.sh version $__VERSION__ with DIRACROOT=$DIRACROOT
echo
...
export PS1="(\[\e[1;38m\]DIRAC3-User\[\e[0m\])[\u@\h \w]\$ "
bash -p
