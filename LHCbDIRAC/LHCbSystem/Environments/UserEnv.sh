#!/bin/bash
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/LHCbSystem/Environments/UserEnv.sh,v 1.1 2008/07/31 10:30:47 rgracian Exp $
# File :   UserEnv.sh
# Author : Ricardo Graciani
########################################################################
__RCSID__="$Id: UserEnv.sh,v 1.1 2008/07/31 10:30:47 rgracian Exp $"
...
echo
echo Running DIRAC UserEnv.sh version $__VERSION__ with DIRACROOT=$DIRACROOT
echo
...
export PS1="(\[\e[1;32m\]DIRAC3-User\[\e[0m\])[\u@\h \w]\$ "
bash -p
