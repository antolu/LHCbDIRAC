#!/usr/bin/env python
########################################################################
# $Header: /tmp/libdirac/tmp.stZoy15380/dirac/DIRAC3/LHCbSystem/scripts/dirac-lhcb-safe-sam-submit-all.py,v 1.1 2008/10/16 09:51:49 paterson Exp $
# File :   dirac-lhcb-safe-sam-submit-all
# Author : Stuart Paterson
########################################################################
__RCSID__   = "$Id: dirac-lhcb-safe-sam-submit-all.py,v 1.1 2008/10/16 09:51:49 paterson Exp $"
