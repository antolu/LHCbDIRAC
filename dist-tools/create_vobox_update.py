...
A_list = ['lbvobox12.cern.ch', 'lbvobox13.cern.ch', 'lbvobox15.cern.ch', 'lbvobox18.cern.ch']
file_B = os.path.join( HOME_DIR, 'vobox_update_B' )
B_list = ['lbvobox23.cern.ch', 'lbvobox24.cern.ch', 'lbvobox25.cern.ch', 'lbvobox27.cern.ch', 'lbvobox28.cern.ch']
...
D_list = ['lbvobox06.cern.ch', 'lbvobox08.cern.ch','lbvobox104.cern.ch','lbvobox105.cern.ch','lbvobox106.cern.ch','lbvobox107.cern.ch','lbvobox108.cern.ch']
