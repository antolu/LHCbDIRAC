...
class TestProductionRequestTestCaseChain( TestProductionRequestTestCase ):
  ...
  def test_mix( self ):
    ...
    # add
    res = self.reqClient.createProductionRequest( {'ParentID':'', 'MasterID':'', 'RequestAuthor': 'anonymous',
                    'RequestName': 'RequestName', 'RequestType': 'RequestType', 'RequestState': 'New',
                    'RequestPriority': '2b', 'RequestPDG':'',
                    'SimCondition':'Beam3500GeV-VeloClosed-MagUp', 'SimCondID':'429215', 'SimCondDetail':'BlahBlahBlah',
                    'ProPath':'Blup', 'ProID':'', 'ProDetail':'BlaaaaaahBlahBlah',
                    'EventType':'900000', 'NumberOfEvents':'-1', 'Description':'Description', 'Comments':'Comments',
                    'Inform':'', 'RealNumberOfEvents':'', 'IsModel':0, 'Extra':''} )
    self.assert_( res['OK'] )
    firstReq = res['Value']
  
    res = self.reqClient.createProductionRequest( {'ParentID':'', 'MasterID':'', 'RequestAuthor': 'anonymous',
                    'RequestName': 'RequestName - new', 'RequestType': 'RequestType', 'RequestState': 'New',
                    'RequestPriority': '2b', 'RequestPDG':'',
                    'SimCondition':'Beam3500GeV-VeloClosed-MagUp', 'SimCondID':'429215', 'SimCondDetail':'BlahBlahBlah',
                    'ProPath':'Blup', 'ProID':'', 'ProDetail':'BlaaaaaahBlahBlah',
                    'EventType':'900000', 'NumberOfEvents':'-1', 'Description':'Description', 'Comments':'Comments',
