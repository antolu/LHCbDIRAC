  ...
  def setUp(self):
    ...
    try:
      ...
      self.exeScriptFromDIRACLocation = find_all(
          'exe-script-fromDIRAC.py', os.environ['WORKSPACE'], '/tests/Workflow/Integration')[0]
...
class GaudirunSuccess(UserJobTestCase):
  ...
  def test_Integration_User_mc(self):
    ...
    oJob.setInputSandbox([find_all('prodConf_Gauss_00012345_00067890_1.py', rootPath, '/tests/Workflow/Integration')[0],
  ...
  def test_Integration_User_boole(self):
    ...
    oJob.setInputSandbox([find_all('prodConf_Boole_00012345_00067890_1.py', rootPath, '/tests/Workflow/Integration')[0],
                          find_all('pilot.cfg', rootPath)[0]])
  ...
  if local:
    try:
      ...
      gaudirunJob.setInputSandbox([find_all('prodConf_Gauss_00012345_00067890_1.py', os.environ['WORKSPACE'],
                                            '/tests/System/GridTestSubmission')[0],
                                   find_all(
          'wrongConfig.cfg', os.environ['WORKSPACE'], '/tests/System/GridTestSubmission')[0],
          find_all('pilot.cfg', os.environ['WORKSPACE'])[0]])
  else:
    try:
      gaudirunJob.setInputSandbox([find_all('prodConf_Gauss_00012345_00067890_1.py', rootPath,
                                            '/tests/System/GridTestSubmission')[0],
